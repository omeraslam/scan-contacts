    ...
    if (contactBox != null) {
      return ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            final contact = contactBox.get(index) as ContactModel;
            final bool alreadySaved =
            fetchFromFavBox.contains(contact); // Add this line.
            return ListTile(
              ...
              trailing: IconButton(
                  icon:
                      alreadySaved ? Icon(Icons.star) : Icon(Icons.star_border),
